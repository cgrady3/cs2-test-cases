...
public class BaselineTests
{
		...
		throws FileNotFoundException
	{
		...
		return checkTest(SneakyKnights.allTheKnightsAreSafe(list, boardSize) == expectedResult);
	}
	...
	public static boolean runBaselineTests() throws FileNotFoundException
	{
		...
		success &= checkTestFromFile("baseline01.txt", false);
		...
		success &= checkTestFromFile("baseline06.txt", false);
